...
void MD5::GenerateMD5(const char* buffer,int bufferlen) {
    GenerateMD5(reinterpret_cast<unsigned char *>(const_cast<char *>(buffer)), bufferlen);;
}
...
//! maybe overflow!
unsigned long MD5::ToULong32() {
    assert(sizeof(unsigned long) == 4);
    unsigned long *pint = (unsigned long *)(m_data);
...
unsigned long long MD5::ToULong64() {
